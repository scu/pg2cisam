/*
 * pgbridge.h: bridge routines between C-ISAM and PostgreSQL APIs
 */

#ifndef _PGBRIDGE_H
#define _PGBRIDGE_H

#include <isam.h>		// Needed for structures and constants (i.e. keydesc)
#include <decimal.h>	// Needed for decimal routines
 ...
 */
int x_isdelindex (int isfd, struct keydesc *key);
